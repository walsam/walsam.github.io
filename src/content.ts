...
export const translations = {
  en: {
    ...
    themeSystem: 'Theme follows device settings',
    themeLight: 'Light theme selected',
    themeDark: 'Dark theme selected',
  ...
  fr: {
    ...
    themeSystem: 'Le thème suit les réglages de l’appareil',
    themeLight: 'Thème clair sélectionné',
    themeDark: 'Thème sombre sélectionné',
